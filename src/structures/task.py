...
class Task:
    ...
    def task_with_period (id, deadline, period, wcet, is_sporadic):
        ...
        assert period > 0 and wcet > 0, "Period and worst-case execution time must be positive numbers."
    ...
    def name(self):       return f"tsk%02d" %self.id
    def v_name(self):     return f"{self.name()}.v"
    def vo_name(self):    return f"{self.name()}.vo"
